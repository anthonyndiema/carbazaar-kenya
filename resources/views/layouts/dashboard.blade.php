...
<head>
    ...
    function drawChart() {
        ...
        var options = {
            title: 'Car Listings Views Performance',
            curveType: 'function',
            legend: {
                position: 'bottom'
            }
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">CARBAZAAR KE</div>
                </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/create-listing">
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; CARBAZAAR KE 2021</span>
                        </div>
                    </div>
                </footer>
                <!-- End of Footer -->
